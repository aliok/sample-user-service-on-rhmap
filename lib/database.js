...
/**
 * Initializes DB related things and provides connection to database.
 *
 * @module lib/database
 */
module.exports = {};
...
/**
 * Promisified Mongoose instance. Exposed to reuse in other places so that
 * we don't need to promisify again and again.
 */
...
module.exports = {
    /**
     * Connects to database. Database to connect to is found out using environment variables compatible
     * with OpenShift.
     * @method
     * @param {Function} callback - callback to call when connected or on error
     */
    connect: connect,
     ...
     * @method
     * @param {Function} callback - callback to call when disconnected or on error
     */
...
/**
 * Builds the MongoDB connection string from passed environment variables.
 * These environment variables are compatible with OpenShift.
 * @private
